...
Hotels.com API integration for hotel search, availability, and booking with loyalty program integration.
...
| Rewards | Loyalty info | Yes |
| Secret Prices | Member deals | Yes |
...
Fallback:
  ...
  fallbacks:
    - tool: expedia
      condition: hotels_com_unavailable
    - tool: booking_com
...
Configuration:
  ...
  api_key: "${HOTELS_COM_API_KEY}"
  api_secret: "${HOTELS_COM_API_SECRET}"
  timeout: 30000
  retries: 3
  rate_limit:
    requests_per_second: 5
...
```yaml
Metrics:
  - hotels_com_requests_total
  - hotels_com_requests_duration_seconds
  - hotels_com_bookings_total
  - hotels_com_errors_total
```

---

*Hotels.com Tool v1.0.0 | Enterprise OTA Platform*
