...
GetYourGuide API integration for tours, activities, and attractions worldwide.
...
Fallback:
  ...
  fallbacks:
    - tool: viator
      condition: getyourguide_unavailable
    - tool: klook
...
```typescript
// Search activities in Barcelona
...
```yaml
Metrics:
  - getyourguide_requests_total
  - getyourguide_requests_duration_seconds
  - getyourguide_bookings_total
  - getyourguide_errors_total
```

---

*GetYourGuide Tool v1.0.0 | Enterprise OTA Platform*
